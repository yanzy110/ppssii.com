...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1577190633, '1', './data/template/1_1_common_header_search_forum.tpl.php', './template/default', 'common/header_search_forum')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1577190633, '1', './data/template/1_1_common_header_search_forum.tpl.php', './template/default', 'common/header_search_forum')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1577190633, '1', './data/template/1_1_common_header_search_forum.tpl.php', './template/default', 'common/header_search_forum')
;?>
